...
// Obtener todos los datos de la BD (igual que antes)
...
$tecnologias_lista = getContent('tecnologias', 'lista', '["⚛️ React","🟢 Node.js","🐍 Python","☁️ AWS","🐳 Docker","🗄️ PostgreSQL","📱 Flutter","🔷 TypeScript"]');
$tecnologias_array = json_decode($tecnologias_lista, true) ?: ["⚛️ React","🟢 Node.js","🐍 Python","☁️ AWS","🐳 Docker","🗄️ PostgreSQL","📱 Flutter","🔷 TypeScript"];
    ...
    <section id="tecnologias">
        <div class="container">
            ...
            <div class="tech-grid fade-up">
                ...
                <div class="tech-item"><?php echo $tech; ?></div>
                <?php endforeach; ?>
            </div>
        </div>
    </section>
