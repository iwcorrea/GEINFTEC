...
(function() {
    ...
    if (rotatingEl.dataset.phrases) {
        try { phrases = JSON.parse(rotatingEl.dataset.phrases); } catch(e) {}
    }
    if (!phrases.length) phrases = ["Ingeniería de vanguardia", "Construcción inteligente", "Software que transforma"];
...
(function() {
    ...
    if (!newsletterForm || !nlFeedback) return;
