...
if (!checkLoginAttempts($ip)) {
    $error = 'Demasiados intentos fallidos. Espera 15 minutos antes de intentar nuevamente.';
}
...
<head>
    ...
    <style>
        ...
        .login-box { background: #1c2541; padding: 2.5rem; border-radius: 16px; box-shadow: 0 20px 60px rgba(0,0,0,0.6); width: 100%; max-width: 400px; border: 1px solid rgba(0,245,212,0.15); }
        ...
        .login-box .footer-text a { color: #00f5d4; text-decoration: none; }
